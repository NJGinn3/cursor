...
export const metadata: Metadata = {
  title: "Violet & Olive - BDSM Matching & Gamification",
  description: "A sophisticated platform for BDSM enthusiasts to connect, explore kinks, and engage in gamified experiences with like-minded individuals.",
};
